...
subject = '1_S'
day = '3'
basepath = 'C:/Users/teodora.vekony/BML-MEMO LAB Dropbox/Lab_workspace/Experiments_Projects/Recent_projects/clinical_brain_projects/TMS_rewiring/Raw_data/'
savepath = 'C:/Users/teodora.vekony/BML-MEMO LAB Dropbox/bml memo members/Teodora_Vekony/GitHub_projects/ASRT_rew_EEG/preproc/Day' + day + '/'

# Load data BrainVision eeg data 
raw = mne.io.read_raw_brainvision(basepath + subject + '/Day'+ day +'/EEG/'+ subject +'_Day'+ day +'.vhdr', preload=True)
print(raw.info)
...
ica_data.save(savepath + subject + '_Day' + day + '_preproc.fif', overwrite=True)
...
with open(savepath + subject +'_Day' + day + '_preproc_info.txt', 'w') as f:
